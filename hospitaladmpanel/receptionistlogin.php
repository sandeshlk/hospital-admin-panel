...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM receptionist WHERE receptionistname = '$username' and receptionistpassword = '$password'";
...
<body>
    <header>
        ...
        <h1 style="color: white;">Receptionist Login</h1>
        <nav>
            <ul>
    ...
    <link rel="stylesheet" type="text/css" href="receptionistloginstyle.css">
</head>
<body>
    <div class="container">
        <div class="login-box">
           <h3 style="text-align: center;">Receptionist Login</h3>
